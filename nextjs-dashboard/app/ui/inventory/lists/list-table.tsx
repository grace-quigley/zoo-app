...
import { ListItemResponse, ListItems } from '@/app/lib/definitions';
import { UpdateItem, DeleteItem } from '../buttons';

export default function ListItemsViewTable({
  listItems
}: {
...
//     await addItemToList(listId, selectedItems.map((item) => item.id))
//   }
//   return (
//     <div className="mt-6 flow-root">
//       <div className="inline-block min-w-full align-middle">
